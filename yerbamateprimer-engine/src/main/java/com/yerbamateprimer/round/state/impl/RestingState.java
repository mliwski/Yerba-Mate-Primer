 ...
 * when the mate is on rest.
 * 
 * @author Matias Liwski
 */
public class RestingState extends StateTemplate implements State {
	private final static StateName STATE_NAME = StateNameImpl.RESTING;
