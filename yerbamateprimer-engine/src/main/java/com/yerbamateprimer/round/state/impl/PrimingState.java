 ...
 * when the mate is primed.
 * 
 * @author Matias Liwski
 */
public class PrimingState extends StateTemplate implements State {
	private final static StateName STATE_NAME = StateNameImpl.PRIMING;
