 ...
 * when someone is drinking the mate.
 * 
 * @author Matias Liwski
 */
public class DrinkingState extends StateTemplate implements State {
	private final static StateName STATE_NAME = StateNameImpl.DRINKING;
