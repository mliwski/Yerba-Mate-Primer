...
public class NotifyEventToCebadorAction implements Action {
	private final static transient Logger LOGGER = LoggerFactory.getLogger(NotifyEventToCebadorAction.class);
	private final static ActionCode ACTION_CODE = ActionCode.NOTIFY_EVENT_TO_CEBADOR;
